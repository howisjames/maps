...
function init() {
  ...
  map = L.map("map").setView([29.3, -94.75], 13); 	
...
function addGeoms(data) {
  ...
  let geomStyle = { color: "yellow", fillColor: 'white', fillOpacity: '0', weight: 2 };
  let geomHoverStyle = { color: "yellow", fillColor: 'white', fillOpacity: '0', weight: 3 };
...
//    marker.bindPopup('<h2>' + data[row].Site + '</h2>' + data[row].Description + '<br>' + data[row].URL + '<br>' + data[row].URL2);
